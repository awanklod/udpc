...
wget -O /etc/udp-request.service '\''https://raw.githubusercontent.com/awanklod/udpc/main/config/udp-request.service'\'' 
   ...
   # [+config+] 
   wget "https://raw.githubusercontent.com/awanklod/udpc/main/config/config.json" -O /etc/udp/config.json &>/dev/null 
